...
export default function AboutMe() {
  ...
  return (
    <motion.section
      ref={ref}
      id="about"
      className="mb-28 max-w-[45rem] text-center leading-8 sm:mb-16 scroll-mt-28"
    ...
    >
      ...
      <p className="mb-3">
        ...
        pursue my passion for Web Development. I dedicated myself and learned{" "}
      ...
      <p>
        ...
        learning about <span className="font-medium">Next.Js</span>
      </p>
    </motion.section>
  );
}
